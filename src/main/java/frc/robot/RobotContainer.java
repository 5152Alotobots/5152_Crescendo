...
public class RobotContainer {
       ...
       switch (ROBOT) {
        ...
        default:
            ...
            */
            ...
            NamedCommands.registerCommand("ScoreSpeakerCenter", new Cmd_ScoreSpeakerCenter(drivetrain));
  ...
  private void configureButtonBindingsCrescendoRobot2024(
    ...
    SubSys_Climber climberSubSys) {
        ...
        //hmiStation.gyroResetButton.onTrue(drivetrain.runOnce(drivetrain::seedFieldRelative));
        hmiStation.gyroResetButton.onTrue(new Cmd_ScoreSpeakerCenter(drivetrain));
