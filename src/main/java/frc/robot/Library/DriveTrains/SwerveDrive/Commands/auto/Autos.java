...
public final class Autos
{
  ...
  public static CommandBase driveAndSpin(SubSys_Swerve swerve)
  {
   ...
   */
  public static CommandBase exampleAuto(SubSys_Swerve swerve)
  {
...
//    swerve.postTrajectory(example);
   ...
   */
  public static CommandBase driveToAprilTag(SubSys_Swerve swerve, int id, Rotation2d rotation,
