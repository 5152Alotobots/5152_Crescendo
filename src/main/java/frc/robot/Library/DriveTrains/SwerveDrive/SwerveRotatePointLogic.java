        ...
        if((rotateLeftPtCmd != rotateLeftPtCmd_prev) || (rotateRightPtCmd != rotateRightPtCmd_prev)){
            ...
            if(rotateLeftPtCmd && !rotateRightPtCmd){
                if (fieldRelative){
                    ...
                    }else if(robotHeading >= (270+SubSys_SwerveDrive_Constants.RotateFieldRelativeMargin)){
                        rotationPt = SubSys_SwerveDrive_Constants.RotationPtBL;
                    ...
                    }else if(robotHeading >= (180+SubSys_SwerveDrive_Constants.RotateFieldRelativeMargin)){
                        rotationPt = SubSys_SwerveDrive_Constants.RotationPtBR;  
                    ...
                    }else if(robotHeading >= (90+SubSys_SwerveDrive_Constants.RotateFieldRelativeMargin)){
