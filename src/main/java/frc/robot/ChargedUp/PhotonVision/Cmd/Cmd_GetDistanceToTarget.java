...
public class Cmd_GetDistanceToTarget extends CommandBase {
  ...
  /**
   * Constructs a new {@link Cmd_GetDistanceToTarget} command with the specified PhotonVision
   ...
   */
  public Cmd_GetDistanceToTarget(
      SubSys_Photonvision subSys_Photonvision, PhotonCamera camera, int pipelineIndex) {
  ...
  public void execute() {
    ...
    if (result.hasTargets()) {
      ...
      // System.out.println("Distance to target: "+ subSys_Photonvision.getRangeToTarget(result,
      // false));
    }
  }
