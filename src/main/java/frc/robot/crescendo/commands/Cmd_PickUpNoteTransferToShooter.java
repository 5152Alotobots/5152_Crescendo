  ...
  public Cmd_PickUpNoteTransferToShooter(SubSys_Intake intakeSubSys, SubSys_Shooter shooterSubSys) {
    ...
    addCommands(
      new ParallelCommandGroup(
        new Cmd_SubSys_Shooter_RotateToDegree(shooterSubSys, () -> ARM_PRESET_TRANSFER).withTimeout(5),
        new Cmd_SubSys_Intake_RotateToDegreeWithLimitSwitch(intakeSubSys, () -> INTAKE_PRESET_PICKUP).withTimeout(5)
      ),  
      new Cmd_SubSys_Intake_IntakeNote(intakeSubSys).withTimeout(5),
      new Cmd_SubSys_Intake_RotateToDegree(intakeSubSys, () -> INTAKE_PRESET_TRANSFER).withTimeout(5),
      new Cmd_TransferIntakeToShooter(shooterSubSys, intakeSubSys).withTimeout(5)
