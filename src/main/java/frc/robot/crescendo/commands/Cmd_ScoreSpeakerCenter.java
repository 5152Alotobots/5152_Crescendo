...
import frc.robot.crescendo.subsystems.shooter.commands.Cmd_SubSys_Shooter_SpeakerCenterShoot;
 ...
 * @param shooterSubSys 
  */
  public Cmd_ScoreSpeakerCenter(SubSys_Shooter subSysShooter) {
    ...
    addCommands(
      new Cmd_SubSys_Shooter_SpeakerCenterShoot(subSysShooter).withTimeout(5)
      );
  }
}
