...
public class Cmd_ScoreSpeakerRight extends SequentialCommandGroup {
  /** Creates a new Cmd_Shoot Speaker Right. 
   ...
   * 5. Stow the Shooter
  */
  public Cmd_ScoreSpeakerRight(SubSys_Shooter shooterSubSys) {
