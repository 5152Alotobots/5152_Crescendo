...
import frc.robot.crescendo.subsystems.shooter.commands.Cmd_SubSys_Shooter_SpeakerLeftShoot;
...
public class Cmd_ScoreSpeakerLeft extends SequentialCommandGroup {
  ...
  */
  public Cmd_ScoreSpeakerLeft(SubSys_Shooter subSysShooter) {
    ...
    addCommands(
      new Cmd_SubSys_Shooter_SpeakerLeftShoot(subSysShooter).withTimeout(5)
    );
  }
}
