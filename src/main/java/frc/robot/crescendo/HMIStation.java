...
public class HMIStation {
    ...
    public final JoystickButton sliderIn = new JoystickButton(coDriverController, 1);
    public final JoystickButton sliderOut = new JoystickButton(coDriverController, 4);
