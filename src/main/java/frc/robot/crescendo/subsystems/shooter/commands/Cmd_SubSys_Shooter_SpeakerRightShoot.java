 ...
 */
public class Cmd_SubSys_Shooter_SpeakerRightShoot extends Command {
    private SubSys_Shooter subSysShooter;
    private boolean atPos = false;

    Timer timer = new Timer();

    public Cmd_SubSys_Shooter_SpeakerRightShoot(
    ...
    public void initialize() {
        timer.reset();
        timer.start();
        subSysShooter.setShooterArmPosCmd(ShooterArm.ShooterArmSpeakerRightPos);
    ...
    public void execute() {
        if(!atPos){
            atPos = subSysShooter.setShooterArmPosCmd(ShooterArm.ShooterArmSpeakerRightPos);
            if(atPos){
                timer.start();
                subSysShooter.shootSpeakerShooterWheels();
            }
